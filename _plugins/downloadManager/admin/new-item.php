...
$(document).ready(function(){
	$("#Upload").click(function(){
		var errors=required(["Name","Upload-Package"]);
		if(errors!=0)
			return false;
	});
...
<form method="post" action="/_inc/ajax.php?file=_plugins/downloadManager/admin/upload.php&page_id='.$page_id.'" enctype="multipart/form-data">
